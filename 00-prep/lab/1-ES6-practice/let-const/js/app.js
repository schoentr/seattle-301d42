...
function displayPics(){
  ...
  // console.log(rando);
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the constiable declaration from ` to `const`.
  // PUT YOUR RESPONSE IN THIS COMMENT
  // Because rando is  scoped  within the function  displayPics, and is not defined in the global scope.
  console.log(viewed);
